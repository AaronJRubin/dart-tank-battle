...
main() {
  ...
  //  print("No local storage, creating default players!");
    createDefaultPlayers();
    stage = new BasicStage(scene);
  } else {
    try {
      String jsonSettings = localStorage['settings'];
    //  print("Settings string retrieved: " + jsonSettings);
      ...
      for (Map playerMap in playerMaps) {
       // print("About to add a new player from the map!");
        players.add(playerFromPolymerMap(playerMap));
       // print("Player added from map");
      }
      int stageID = settings['stage'];
     // print("Retrieved stageID was " + stageID.toString());
      switch (stageID) {
